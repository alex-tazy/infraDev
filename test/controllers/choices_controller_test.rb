...
class ChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post choices_url, params: { choice: { election_id: @choice.election_id, name: @choice.name } }
    end
  ...
  test "should update choice" do
    patch choice_url(@choice), params: { choice: { election_id: @choice.election_id, name: @choice.name } }
