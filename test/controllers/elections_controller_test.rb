...
class ElectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create election" do
    assert_difference('Election.count') do
      post elections_url, params: { election: { end_date: @election.end_date, groups: @election.groups, start_date: @election.start_date, title: @election.title } }
    end
  ...
  test "should update election" do
    patch election_url(@election), params: { election: { end_date: @election.end_date, groups: @election.groups, start_date: @election.start_date, title: @election.title } }
